...
def run(playwright):
    ...
    page.fill('textarea[placeholder="Enter your message"]', 'This is a sample message.')

    # Select the gender option (radio button) first
    page.click('input[name="gender"][value="male"]')  # Select male option (change to "female" or "other" as needed)

    # Now set the date of birth
    page.fill('input[type="date"]', '1990-01-01')  # Set Date of Birth in YYYY-MM-DD format
