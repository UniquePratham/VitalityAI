...
export default function AIDiagnosis() {
  ...
  const handleDiagnosis = async () => {
    ...
    try {
      ...
      // Assuming response.data contains the structured response with fields:
      // - diagnosisProbabilities
      // - image
      // - websiteUrl
      const { diagnosisProbabilities, image, websiteUrl } = response.data;

      setDiagnosis({ diagnosisProbabilities, image, websiteUrl });
    } catch (error) {
      ...
      {loading ? (
        ...
        diagnosis && (
          ...
          >
            ...
            {diagnosis.diagnosisProbabilities ? (
              <Box mb={4}>
                {Object.entries(diagnosis.diagnosisProbabilities).map(
            ...
            {diagnosis.image && (
              <Image src={diagnosis.image} alt="Patient Characteristics" mb={4} />
            )}
