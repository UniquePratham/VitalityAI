...
(async () => {
    ...
    await page.waitForSelector('select[name="gender"]'); // Adjust the selector if needed
    await page.select('select[name="gender"]', 'female'); // Replace 'female' with 'male' or 'prefer-not-to-say' as needed
