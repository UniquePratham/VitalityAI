...
def run(playwright):
    ...
    page.goto('https://sample-form-e2b82.web.app/')
    ...
    page.fill('textarea[placeholder="Enter your message"]',
    ...
    date_of_birth = '01-01-1990'  # Date in DD-MM-YYYY format

    # Open the date picker
    page.click('input[type="date"]')

    # Fill the date field (if the calendar widget allows direct input)
    page.fill('input[type="date"]', '1990-01-01')  # Use YYYY-MM-DD format

    # Alternatively, interact with the date picker if it doesn't accept direct input
    # This step will vary based on how the date picker is implemented
    # For example, you might need to click on the specific date in the calendar widget
